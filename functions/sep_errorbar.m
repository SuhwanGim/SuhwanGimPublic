function [line_handel, errorbar_handel] = sep_errorbar(x, y, e, prop, varargin)
% Draw a shorter line plots between point with errorbar.
%
% :Usage:
% ::
%
...
%
% ..
%    Copyright (C) 2019 Suhwan Gim and Wani Woo
% ..
...
for i = 1:(numel(x)-1)
    ...
    line_handel(i) = plot(newx, newy, 'color', col, 'linewidth', linew, 'linestyle', lines);
end
hold on;
errorbar_handel = errorbar(x, y, e, 'o', 'color', 'k', 'linewidth', 1.5, 'markersize', 12, 'markerfacecolor', marker_color);
errorbar_handel.CapSize = 0;
hold off;
end